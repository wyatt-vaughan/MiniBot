...
#define ROBOT_MAX_VELOCITY_MM_S    250.0f   // Maximum linear velocity (mm/s) NOT REALLY USED
...
static_assert(EMAG_COUNT * (EMAG_FWD_ON_TIME_MS + EMAG_REV_ON_TIME_MS) <= EMAG_FRAME_LEN_MS,
